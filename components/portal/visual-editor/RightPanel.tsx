...
export function RightPanel({
  ...
  /** VEQA-041 — forwarded to BlockContentEditor -> ContentPanel so the
   *  button's Hover Effect control can force-preview on the canvas. */
          ...
          <>
            {isMultiSelect ? (
              ...
              <SingleBlockPane
                ...
                onForceHoverChange={onForceHoverChange}
              />
            ) : noSelectionPanel ? (
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {rightPanelTab === 'content' ? (
          selectedCustomManifest ? (
            ...
            <BlockContentEditor block={selectedBlock} onUpdate={(updates) => handleUpdateBlock(selectedBlock.id, updates)} siteId={siteId} onForceHoverChange={onForceHoverChange} />
          )
        ) : (
          <>
            {siteId !== undefined && (
