  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">Use the controls in the editor to add, remove, or resize columns.</p>
      </div>
        ...
        <div className="space-y-3">
          <label className="flex items-start gap-2 text-sm cursor-pointer">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">Columns display vertically on screens ≤ 767px</div>
            </div>
          </label>
          <label className="flex items-start gap-2 text-sm cursor-pointer">
            <input
