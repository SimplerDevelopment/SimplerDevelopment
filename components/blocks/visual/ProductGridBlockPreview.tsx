      ...
      <div className="container mx-auto px-4">
        ...
        <div className={`grid grid-cols-1 ${columnClasses[block.columns || 3]} gap-8`}>
          {displayProducts.map((product, i) => (
            <div key={i} className="h-full rounded-lg border bg-card overflow-hidden transition-all hover:shadow-lg">
              ...
              <div className="p-4">
                ...
                {block.showDescription && (
                  <p className="text-sm text-muted-foreground mb-2 line-clamp-2">Sample product description goes here</p>
                )}
