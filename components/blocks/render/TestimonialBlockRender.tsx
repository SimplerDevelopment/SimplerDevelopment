    ...
    <div className={`py-16 ${responsiveClasses}`}>
      <div className="max-w-4xl mx-auto text-center">
        <div className="relative">
          ...
          <blockquote data-editable-field="quote" className={`${hasCustomFontSize ? '' : 'text-xl md:text-2xl'} ${hasCustomFontWeight ? '' : 'font-medium'} ${hasCustomColor ? '' : 'text-foreground'} mb-8`} style={getElementCSS(block.elementStyles, 'quote')}>
            {block.quote}
          </blockquote>
          ...
          <div className="flex flex-col items-center">
            ...
            <cite className="not-italic">
              <div data-editable-field="author" className={`${hasCustomFontWeight ? '' : 'font-semibold'} ${hasCustomColor ? '' : 'text-foreground'}`} style={getElementCSS(block.elementStyles, 'author')}>{block.author}</div>
