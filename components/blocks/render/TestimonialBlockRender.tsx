    ...
    <div className={`py-16 ${responsiveClasses}`}>
      <div className="max-w-4xl mx-auto text-center">
        <div className="relative">
          ...
          <blockquote data-editable-field="quote" className="text-xl md:text-2xl font-medium text-foreground mb-8" style={getElementCSS(block.elementStyles, 'quote')}>
            {block.quote}
          </blockquote>
          ...
          <div className="flex flex-col items-center">
            ...
            <cite className="not-italic">
              <div data-editable-field="author" className="font-semibold text-foreground" style={getElementCSS(block.elementStyles, 'author')}>{block.author}</div>
