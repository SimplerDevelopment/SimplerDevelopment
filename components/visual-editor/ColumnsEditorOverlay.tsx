...
export function ColumnsEditorOverlay({
  ...
  return (
    <>
      ...
      {/* Gap drag handle — small pill offset right of bottom-center so it no
          longer sits on top of the section height resize handle (which is at
          bottom-center) and steal its clicks. */}
      {columns.length > 1 && (
        <div
