...
// fake-data test tenant (no real client PII). Kept separate from
// lib/data/solutions.ts so the screenshot manifest can change independently of
// the solution copy/registry.
