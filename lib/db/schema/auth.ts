...
export const users = pgTable('users', {
  ...
  // Recent bcrypt password hashes (most-recent first, capped at
  // PASSWORD_HISTORY_LIMIT). Reset/change reject a new password that matches the
  // current one or any entry here — no reuse of recent passwords (AUTH79-002).
