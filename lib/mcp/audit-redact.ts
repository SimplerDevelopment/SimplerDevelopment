...
/**
 * Return a redacted copy of `args` with secret-bearing keys stripped —
 ...
 * stripped before the result is encrypted at rest.
 */
export function redactSecretsOnly(args: unknown): unknown {
