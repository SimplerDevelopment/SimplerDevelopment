...
[`./cli`](./cli) — `npm install -g @simplerdevelopment/cli` for a JSON-first terminal client with 451-tool parity: manage posts, CRM, projects, and everything else from your shell or CI.
