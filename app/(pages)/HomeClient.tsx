          ...
          <div className="max-w-6xl mx-auto">
            ...
            <FadeIn delay={0.1}>
              {/* Framed product visual — a real portal dashboard screenshot
                  (public/screenshots/product/dashboard.webp). Swap for a short
              ...
              <div className="rounded-2xl border border-border bg-background shadow-2xl overflow-hidden">
                ...
                <div className="relative max-h-[360px] md:max-h-[540px] overflow-hidden bg-muted/20">
                  ...
                  <img
                    src="/screenshots/product/dashboard.webp"
              ...
              <FadeIn>
                <div className="lg:sticky lg:top-32">
                  ...
                  <h2 className="font-display text-4xl md:text-5xl font-bold leading-tight">
                    Built in the open.{' '}
                    <span className="text-primary">Join us early.</span>
                  </h2>
                  <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                    SimplerDevelopment is Apache-2.0 licensed and self-hostable — no lock-in, no
                    per-seat tax. The whole platform is yours to run, fork, and extend. It&apos;s early,
                    which makes right now the best time to get involved.
                  </p>
                  ...
                  <div className="p-8 rounded-2xl bg-foreground text-background">
                    ...
                    <div className="mt-6 flex flex-wrap gap-3">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center gap-2 rounded-lg px-6 py-3 font-medium border-2 border-background/30 text-background hover:bg-background/10 transition-colors"
                      >
                        Contributing guide
                      </a>
                      <a
                        href="https://github.com/SimplerDevelopment/SimplerDevelopment/issues"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center gap-2 rounded-lg px-6 py-3 font-medium border-2 border-background/30 text-background hover:bg-background/10 transition-colors"
                      >
                    ...
                    <p className="mt-4 text-sm opacity-60">
                      Apache-2.0 · Self-host anywhere · 450+ MCP tools · PRs welcome
                    </p>
                  </div>
                </SlideIn>
              </div>
