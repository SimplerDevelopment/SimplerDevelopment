      ...
      <div className="max-w-5xl mx-auto">
          ...
          <div>
            <SlideIn direction="right" delay={0.1}>
              <div className="border border-border rounded-lg p-6 h-full">
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  Prefer to write? Send us a message and we'll get back to you soon
                </p>
                <ContactForm />
              </div>
            </SlideIn>
        ...
        <div className="border-t border-border pt-12">
          <SlideIn direction="up" delay={0.2}>
            ...
            <div className="max-w-2xl mx-auto p-6 bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg text-center">
