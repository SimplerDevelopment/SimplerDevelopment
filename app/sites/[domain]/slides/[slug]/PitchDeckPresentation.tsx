...
export default function PitchDeckPresentation({ slides, theme, title, isDraft, surveys = {}, branding }: Props) {
  ...
  // Animation-end timer. Held in a ref so it can be cleared on unmount —
  // otherwise a pending setIsAnimating fires after teardown (crashes jsdom
  // tests with "window is not defined"; leaks in the browser).
