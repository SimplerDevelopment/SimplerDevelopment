...
export async function POST(
  ...
  // recipientEmail is optional: "send" marks the proposal 'sent' and returns a
  // shareable proposalUrl — it does not email anyone here. Reject only a
  // provided-but-malformed value; an absent one is fine (QAD: the frontend
  // "Send" buttons post no body, which had 400'd since 899ca92d4).
