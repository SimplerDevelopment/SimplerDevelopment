...
export async function POST(req: Request) {
  ...
  // Cap 6-digit-code attempts per account — otherwise a session-holder could
  // brute-force the 10^6 TOTP space and forge the second factor at enrollment.
  if (!(await checkRateLimit(`mfa-verify:${userId}`, 10, 15 * 60 * 1000))) {
