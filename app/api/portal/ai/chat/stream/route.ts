...
export async function POST(req: Request) {
  ...
  // neither is set, gate is undefined and writes execute directly (prior behavior).
  const gateCtx =
    ctx.requireCmsApproval || client.aiChatRequiresApproval
      ? { ...ctx, requireCmsApproval: true }
      : undefined;
