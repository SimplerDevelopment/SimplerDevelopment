...
import {
  ...
  projects, clientWebsites, aiCreditBalances, aiConversations,
  orders, crmDeals, crmContacts, crmProposals, emailCampaigns,
  bookingPages, bookings, automationRules, hostedSites,
} from '@/lib/db/schema';
import { count, eq, sql, and, gte, or, isNull } from 'drizzle-orm';
...
export async function GET() {
  ...
  const [
    ...
    // Invoice stats (outstanding + collected)
    db.select({
