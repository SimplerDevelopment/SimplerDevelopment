...
const TOOL_LABELS: Record<string, string> = {
  ...
  get_my_services: 'subscriptions',
  get_my_websites: 'websites',
  get_website_pages: 'pages',
  get_website_categories: 'categories',
  get_website_tags: 'tags',
  get_website_media: 'media',
  get_my_hosted_sites: 'hosting',
  get_my_email_campaigns: 'campaigns',
  get_my_email_lists: 'email lists',
  get_my_pitch_decks: 'pitch decks',
  get_my_booking_pages: 'booking pages',
  get_bookings_for_page: 'bookings',
  get_suggested_projects: 'suggested projects',
  get_my_team: 'team',
  get_my_profile: 'profile',
  create_support_ticket: 'ticket created',
  reply_to_ticket: 'ticket reply',
  add_card_comment: 'comment added',
  create_website_page: 'page created',
  publish_page: 'page updated',
  create_website_category: 'category created',
  create_website_tag: 'tag created',
  request_service: 'service requested',
  request_suggested_project: 'project requested',
  update_profile: 'profile updated',
  invite_team_member: 'member invited',
