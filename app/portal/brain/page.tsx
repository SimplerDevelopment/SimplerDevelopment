    ...
    <div className="max-w-5xl mx-auto py-8 space-y-6">
      ...
      <div className="bg-card border border-border rounded-lg p-6">
        ...
        <ul className="text-sm text-muted-foreground space-y-1.5 list-disc list-inside">
          <li>Phase 2 — Meeting ingestion (paste transcript) + AI review queue</li>
          <li>Phase 3 — Brain tasks with promotion to project boards</li>
          <li>Phase 4 — Command-center dashboard with priorities, overdue work, and stale prospects</li>
