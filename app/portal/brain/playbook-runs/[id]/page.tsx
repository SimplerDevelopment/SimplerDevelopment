  ...
  return (
    <div className="max-w-4xl mx-auto py-4 space-y-6">
      ...
      <div className="bg-card border border-border rounded-xl p-5">
        <div className="flex items-start justify-between gap-3 flex-wrap">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-2xl font-bold text-foreground">{run.label}</h1>
              <span
        ...
        {run.abortReason && (
          <div className="mt-4 bg-muted/30 border border-border rounded-md p-3 text-xs text-muted-foreground">
        ...
        {error && (
          <div className="mt-4 bg-destructive/10 border border-destructive/30 rounded-md p-3 text-xs text-destructive">
