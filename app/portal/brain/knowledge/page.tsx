    ...
    <div className="fixed inset-0 top-[var(--portal-header-height,3.5rem)]">
      {isNarrow ? (
        ...
        <Group orientation="horizontal">
          {/* react-resizable-panels v4: Group/Separator (was PanelGroup/PanelResizeHandle),
              orientation (was direction), and sizes are percent-STRINGS (v4 numbers = px).
              autoSaveId was removed in v4 — panel sizes no longer persist across reloads;
              re-add via useDefaultLayout(panelIds, storage) if that UX is wanted. */}
          <Panel
            defaultSize="20"
            minSize="14"
            maxSize="40"
          ...
          <Separator className="w-px bg-border hover:bg-primary/40 transition-colors data-[resize-handle-active]:bg-primary" />
