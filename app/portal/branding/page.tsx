    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Create and manage brand profiles. Assign them to websites, pitch decks, and proposals.
        </p>
      </div>
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-foreground">Brand Profiles</h2>
          <button
      ...
      {websites.length > 0 && profiles.length > 0 && (
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-foreground">Website Assignments</h2>
