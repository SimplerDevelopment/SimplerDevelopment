...
// Extracted verbatim from app/portal/agency/branding/page.tsx for PUX-196.
...
import { pBtnPrimary, pInput, sBtn } from '@/components/portal/portal-ui';
...
export default function AgencyBrandingForm({
  ...
  function setColor(next: string) {
    setState(s => ({ ...s, agencyPrimaryColor: next }));
