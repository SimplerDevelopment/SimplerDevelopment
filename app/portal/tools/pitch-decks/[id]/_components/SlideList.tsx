                    ...
                    {surveyList.filter(s => s.status === 'active').map(s => (
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-muted-foreground">{Array.isArray(s.fields) ? (s.fields as { type?: string }[]).filter(f => f.type !== 'page_break' && f.type !== 'heading' && f.type !== 'image' && f.type !== 'video').length : 0} questions</div>
                        </div>
                      </button>
                    ))}
                  </div>
