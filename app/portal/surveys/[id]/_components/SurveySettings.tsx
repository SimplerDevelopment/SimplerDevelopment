...
interface Props {
  ...
  // SCORE-02: survey-level scoring config (auto-route-to-CRM). Only relevant
  // when at least one field has `scoring` configured — the panel hides itself
  // otherwise, but the state is always threaded so save() can clear it.
