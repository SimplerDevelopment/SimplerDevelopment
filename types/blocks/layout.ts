...
export interface SpacerBlock extends BaseBlock {
  type: 'spacer';
  // Preset token OR any CSS length ('40px', '5rem') — the Style-tab Height and
  // the resize handle write a raw length; SpacerBlockRender honors it (VEQA-058).
 ...
 * sticky-scroll-tabs pattern. Universal — usable for any
