...
// CRM write routes intentionally NOT entitlement-gated: user notification
// state, not paid-module business data (marking a notification read must not
// require a subscription).
const CRM_WRITE_UNGATED = new Set<string>([
  'app/api/portal/crm/notifications/route.ts',
  'app/api/portal/crm/notifications/[id]/route.ts',
  'app/api/portal/crm/notifications/mark-all-read/route.ts',
  'app/api/portal/crm/notification-preferences/route.ts',
]);
