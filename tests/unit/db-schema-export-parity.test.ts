...
const EXPECTED_TABLE_NAMES: Readonly<Record<string, string>> = {
  ...
  crmDeals: 'crm_deals',
  crmEmailMessages: 'crm_email_messages',
  ...
  crmSequenceEnrollments: 'crm_sequence_enrollments',
  crmSequenceSends: 'crm_sequence_sends',
  crmSequenceSteps: 'crm_sequence_steps',
  crmSequences: 'crm_sequences',
  crmTags: 'crm_tags',
  ...
  emailJourneyEnrollments: 'email_journey_enrollments',
  emailJourneyStepSends: 'email_journey_step_sends',
  emailJourneySteps: 'email_journey_steps',
  emailJourneys: 'email_journeys',
  emailLists: 'email_lists',
  emailRenders: 'email_renders',
  emailSegments: 'email_segments',
  emailSignupForms: 'email_signup_forms',
  ...
  evalCaseResults: 'eval_case_results',
  ...
  siteWebhookDeliveries: 'site_webhook_deliveries',
  siteWebhooks: 'site_webhooks',
