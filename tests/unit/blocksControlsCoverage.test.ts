...
const TYPE_TO_RENDERER: Record<string, string> = {
  ...
  'hero-cta': 'components/blocks/render/HeroCtaBlockRender.tsx',
  ...
  'navigation': 'components/blocks/render/NavigationBlockRender.tsx',
...
const PANEL_FILES = [
  ...
  'components/blocks/visual/block-settings/panels/HeroCtaSettings.tsx',
