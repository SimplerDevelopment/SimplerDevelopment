 ...
 *
 * Covers drainQueue (success + failure + retry + empty pick + concurrency
 * limits) and getQueueStats. (enqueueEmbedding/enqueueEmbeddingsBulk were
 * removed as dead code — a Postgres trigger now owns enqueueing; see
