...
// SurveyFormInline disarms Submit for 500ms after mount/page-entry (guards
// against the double-click-Next ghost submit — see SurveyFormInline.tsx
// pageEnteredAtRef). Tests fire submit synchronously right after render,
// landing inside that window, so nudge Date.now() forward before submitting.
function armSubmit() {
  const real = Date.now();
