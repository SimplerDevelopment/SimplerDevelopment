...
- [ ] ✓ verified 2026-06-20 — review-items approve mutation: POST /brain/review-items/[id]/approve commits AI-generated content to canonical data (cov-u5.spec.ts)
- [ ] ✓ verified 2026-06-20 — review-items reject mutation: POST /brain/review-items/[id]/reject discards a pending review item (cov-u6.spec.ts)
- [ ] ✓ verified 2026-06-20 — saved-searches CRUD lifecycle: create → list → update → delete a saved search filter (cov-u6.spec.ts)
- [ ] ✓ verified 2026-06-20 — brain note custom fields: POST /brain/knowledge/[id]/fields creates a field value; PATCH updates it; DELETE removes it (cov-u6.spec.ts)
- [ ] ✓ verified 2026-06-20 — topics attach + for-entity: POST /brain/topics/attach links a topic to a note/decision/initiative; GET /topics/for-entity returns attached topics (cov-u6.spec.ts)
- [ ] ✓ verified 2026-06-20 — topics merge: POST /brain/topics/[id]/merge re-parents children and re-attaches entities then deletes source (cov-u7.spec.ts)
- [ ] ✓ verified 2026-06-20 — org-unit merge: POST /brain/org-units/[id]/merge moves members and children to target then deletes source (cov-u7.spec.ts)
- [ ] ✓ verified 2026-06-20 — task promote-to-kanban: POST /brain/tasks/[id]/promote-to-kanban creates a Kanban card and links back to the brain task (cov-u7.spec.ts)
