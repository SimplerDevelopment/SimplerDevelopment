...
- Activation: ~~demo-seeded workspace →~~ agent-led "set up YOUR business" from an empty workspace (demo-seeder removed 2026-07-09, OBQA-003 — see [[ADR demo-seed-vs-onboarding-detections]]).
