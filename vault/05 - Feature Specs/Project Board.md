...
- [ ] CRM email engagement: Outlook/Microsoft email sync + sequences/cadences + signed→onboarded lifecycle automation `[verified 2026-06-21 real-gap; pipeline rename/delete + Gmail-inbound→Brain already shipped]` — see [[CRM E2E Audit]]
