...
- [ ] Pitch-deck sharing: viewer analytics (views/time-on-slide) + shared-link access control (password/expiry) `[verified 2026-06-21; publish approval gate + portal deck-fork (e2ca8508) already shipped]` — see [[Pitch Decks Product Designer E2E Audit]]
