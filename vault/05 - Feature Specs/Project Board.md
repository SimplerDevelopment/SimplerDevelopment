...
- [ ] Email automation depth: deliverability testing (inbox/spam) + embedded list-growth forms `[verified 2026-06-21; approval-vs-send gate already shipped]` `[2026-06-22: P1 BRANCHING JOURNEYS SHIPPED (d72935a7) — journeys/steps/enrollments + advance cron + portal CRUD; 15 e2e. REMAINING: P2 deliverability (external) + P3 signup forms (local)]` — see [[Spec - Email Branching Journeys]] · [[Email Campaigns E2E Audit]]
...
- [ ] Agentic OS: agent-action audit trail — runId wiring + review UI `[verified 2026-06-21]` `[2026-06-22: P1 + INSTRUMENTATION SHIPPED (b338800b) — agent_action_logs table + wrapRegisterTool now writes audit rows + redact helper (9 unit tests). REMAINING: runId env→ctx wiring (P2) + admin/portal review views (P3) + tool-call→row integration test]` — see [[Spec - Agentic OS Audit Trail]] · [[00 - E2E Audit Index]]
