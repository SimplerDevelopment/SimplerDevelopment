...
- [ ] CRM email engagement: Phase 3 Outlook (Mail scopes + Graph sync/send) + small follow-ups (event-bus auto-enroll, thread UI, send-as-user) `[2026-06-22: Phase 1 Gmail threads (c2c0886c) + Phase 2 sequences/cadences (533c6487) SHIPPED]` — see [[Spec - CRM Email Sync + Sequences]] · [[CRM E2E Audit]]
