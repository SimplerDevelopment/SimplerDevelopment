...
(function () {
  ...
  var NAV_HTML = [
    ...
    '    </ul>',
    '    <a class="mc-nav__cta" href="tel:+12153891817" aria-label="Call (215) 389-1817">',
    '      <span class="material-icons mc-nav__cta-icon" style="font-size:14px;">call</span>',
    '      <span class="mc-nav__cta-label">(215) 389-1817</span>',
    '    </a>',
